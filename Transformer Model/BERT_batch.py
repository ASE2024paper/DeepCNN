...
X_res, y_res = sm.fit_resample(X_train.numpy(), y_train.numpy())
...
model.fit([X_res, mask_train], y_res, batch_size=batch_size, epochs=epochs, validation_split=validation_split)
